...
public class MahasiswaDriver_2511532028 {
	Scanner i = new Scanner(System.in);
	
	// 1. Method untuk menampilkan menu
	public static void tampilkanMenu_2511532028() {
		System.out.println("\nMenu : ");
	...
	public static void tambahMahasiswa_2511532028(ArrayList<Mahasiswa_2511532028> list, Scanner sc) {
		...
		list.add(new Mahasiswa_2511532028(nim, nama, prodi));
		System.out.println("Mahasiswa berhasil ditambahkan.");
		}
	
	// 3. Method untuk tampilkan semua data
	public static void tampilkanSemuaMahasiswa_2511532028(ArrayList<Mahasiswa_2511532028> list) {
		if(list.isEmpty()) {
	...
	public static void cariMahasiswa_2511532028(ArrayList<Mahasiswa_2511532028> list, Scanner sc) {
	...
	public static void main(String[] args) {
		ArrayList<Mahasiswa_2511532028> mahasiswaList = new ArrayList<>();
		Scanner scanner = new Scanner(System.in);
		int choice;
		
		do { 
			tampilkanMenu_2511532028();
			...
			switch (choice) {
				case 1:
					tambahMahasiswa_2511532028(mahasiswaList, scanner);
					break;
				case 2:
					tampilkanSemuaMahasiswa_2511532028(mahasiswaList);
					break;
				case 3:
					hapusMahasiswa_2511532028(mahasiswaList, scanner);
					break;
				case 4:
					cariMahasiswa_2511532028(mahasiswaList, scanner);
					break;
				case 5:
